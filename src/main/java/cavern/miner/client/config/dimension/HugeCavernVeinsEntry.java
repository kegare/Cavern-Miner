...
public class HugeCavernVeinsEntry extends CategoryEntry
{
	...
	{
		return new GuiVeinsEditor(owningScreen, WorldProviderHugeCavern.VEINS, () -> getAutoVeins(), () -> getAutoVeinsBlacklist());
	}
	...
	{
		return HugeCavernConfig.VEINS.getCaveVeins().isEmpty();
	}
