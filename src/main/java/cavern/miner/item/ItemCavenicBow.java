...
import cavern.miner.entity.projectile.EntityRapidArrow;
import cavern.miner.entity.projectile.EntityTorchArrow;
...
public class ItemCavenicBow extends ItemBow
{
	public ItemCavenicBow()
	{
		...
		this.addPropertyOverride(new ResourceLocation("pull"), new IItemPropertyGetter()
		{
			...
			{
				if (entity == null || entity.getActiveItemStack().getItem() != ItemCavenicBow.this)
				{
					return 0.0F;
				}
