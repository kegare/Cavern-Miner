...
public class CavenicShovelItem extends ShovelItem implements CavenicTool
{
	public CavenicShovelItem(IItemTier tier, float attackDamage, float attackSpeed, Properties builder)
	{
