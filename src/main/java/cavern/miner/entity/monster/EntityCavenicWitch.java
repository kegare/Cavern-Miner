...
public class EntityCavenicWitch extends EntityWitch
{
	private static final ResourceLocation LOOT_CAVENIC_WITCH = LootTableList.register(CaveUtils.getKey("entities/cavenic_witch"));
