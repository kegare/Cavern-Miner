...
public class WorldGenPervertedTrees extends WorldGenTrees
{
	...
	public WorldGenPervertedTrees(boolean flag, int min, IBlockState wood, IBlockState leaves, boolean grow)
	{
		super(flag);
	...
	public WorldGenPervertedTrees(boolean flag, int min, BlockPlanks.EnumType type, boolean grow)
	{
		this(flag, min,
					...
					for (int y = pos.getY() - i + treeHeight; y <= pos.getY() + treeHeight; ++y)
					{
						...
						for (int x = pos.getX() - range; x <= pos.getX() + range; ++x)
						{
							...
							for (int z = pos.getZ() - range; z <= pos.getZ() + range; ++z)
							{
								...
								{
									state = world.getBlockState(blockpos.setPos(x, y, z));
