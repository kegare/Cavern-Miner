...
public class CavernBiome extends Biome
{
	public CavernBiome()
	{
		...
		this.addCarver(GenerationStage.Carving.AIR, new CaveConfiguredCarver<>(() -> CaveWorldCarvers.CAVERN.get(), new ProbabilityConfig(0.2F)));
		this.addCarver(GenerationStage.Carving.AIR, new CaveConfiguredCarver<>(() -> CaveWorldCarvers.EXTREME_CAVE.get(), new ProbabilityConfig(0.2F)));
