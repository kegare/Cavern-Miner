...
public final class PlayerUtils
{
	...
	private static boolean bedInRange(Entity entity, BlockPos pos, EnumFacing facing)
	{
	...
	private static void setSize(Entity entity, float width, float height)
	{
		if (width != entity.width || height != entity.height)
		{
			...
			if (entity.width > f && !entity.world.isRemote && !entity.firstUpdate)
			{
	...
	private static void setRenderOffsetForSleep(EntityPlayer player, EnumFacing facing)
	{
